...
TRANSLATIONS = {
    ...
    "window_title":          {"en": "CNC Control (GRBL-ESP32 / MKS DLC32)",
                              "th": "ควบคุม CNC (GRBL-ESP32 / MKS DLC32)"},
    "menu_control":          {"en": "Control",          "th": "ควบคุม (Control)"},
    "menu_gcode":            {"en": "G-code program",   "th": "โปรแกรม G-code"},
    "menu_settings":         {"en": "Settings",         "th": "ตั้งค่า (Settings)"},
    "menu_exit":             {"en": "Exit",             "th": "ออก (Exit)"},
    ...
    "grp_connection":        {"en": "🔌 Connection",    "th": "🔌 การเชื่อมต่อ (Connection)"},
    ...
    "btn_estop":             {"en": "🛑 E-STOP",         "th": "🛑 หยุดฉุกเฉิน (E-STOP)"},

    # ── Control Page – Jog Control ──
    "grp_jog":               {"en": "🕹️ Jog Control",   "th": "🕹️ ควบคุมทิศทาง (Jog)"},
    ...
    "lbl_wp_time":           {"en": "Time(s):",           "th": "เวลา(วิ):"},
    ...
    "btn_home_h":            {"en": "Home ($H)",          "th": "Home ($H)"},
    "btn_unlock_x":          {"en": "Unlock ($X)",        "th": "ปลดล็อค ($X)"},
    "btn_set_zero_g54":      {"en": "Set Work Zero (G54)","th": "ตั้งจุดศูนย์ชิ้นงาน (G54)"},
    "btn_go_zero_g53":       {"en": "Go Machine Zero (G53)","th": "ไปจุดศูนย์เครื่อง (G53)"},
    "btn_reset_ctrl_x":      {"en": "Reset (Ctrl+X)",     "th": "รีเซ็ต (Ctrl+X)"},
    "cb_auto_x_reset":       {"en": "Auto $X after Reset","th": "ปลดล็อคอัตโนมัติหลังรีเซ็ต"},
    "btn_run_estop":         {"en": "E-STOP",             "th": "หยุดฉุกเฉิน (E-STOP)"},
    ...
    "btn_run_send":          {"en": "Send",               "th": "เริ่มทำงาน (Start)"},
    ...
    "lbl_baud":              {"en": "Baud rate",          "th": "อัตราบอด (Baud)"},
    "lbl_poll_ms":           {"en": "Status poll interval (ms)", "th": "ช่วงเวลาสำรวจสถานะ (ms)"},
    ...
    "lbl_soft_limits":       {"en": "Soft Limits (mm)",   "th": "ขีดจำกัดซอฟต์ (mm)"},
    "lbl_safe_z":            {"en": "Safe Z height (mm)", "th": "ความสูง Z ปลอดภัย (mm)"},
    "lbl_theme":             {"en": "Theme",              "th": "ธีม"},
    "btn_apply":             {"en": "Apply (No Save)",    "th": "ใช้งาน (ไม่บันทึก)"},
    ...
    "btn_test_conn":         {"en": "Test Connection ($I)","th": "ทดสอบการเชื่อมต่อ ($I)"},
