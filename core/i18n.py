...
TRANSLATIONS = {
    ...
    "hard_limit_log_start":  {"en": "🔧 Auto-Recovery starting... (back off 2mm)",
                              "th": "🔧 เริ่มกู้คืนอัตโนมัติ... (ถอย 2mm)"},
