...
class RunPage(QWidget):
    def __init__(self, app_ref):
        ...
        self.reset_btn2.setStyleSheet("QPushButton { background-color: #e0a800; color: black; font-weight: bold; }")
        ...
        self.unlock_btn.clicked.connect(lambda: self.app._do_unlock())
